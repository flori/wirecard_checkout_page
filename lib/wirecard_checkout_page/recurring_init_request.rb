module WirecardCheckoutPage
  class RecurringInitRequest < InitRequest
    include WirecardCheckoutPage::Utils

    def initialize(params: {})
      super params: params
      self.transactionIdentifier = 'INITIAL'
    end
    ...
    def call
      ...
      RecurringInitResponse.from_typhoeus_response Typhoeus.post(DEFAULT_URL, body: body)
    end
